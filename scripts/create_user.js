...
// Create admin client (using service_role key to bypass email confirmation)
...
async function createInitialAdmin() {
  ...
  if (authError) {
    if (authError.message.includes('already registered')) {
      console.warn('⚠️ User already exists in Auth. Checking profile...');
  ...
  if (roleFetchError) {
    console.error('❌ Error fetching admin role:', roleFetchError.message);
    return;
  }
