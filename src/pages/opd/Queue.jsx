  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-200">
        ...
        <button onClick={loadQueue} className="flex items-center gap-2 text-slate-500 hover:text-primary-600 transition-colors pb-3 px-2">
          <Refresh sx={{ fontSize: 18 }} />
          <span className="text-xs font-black uppercase tracking-wider">Refresh List</span>
        </button>
      </div>
